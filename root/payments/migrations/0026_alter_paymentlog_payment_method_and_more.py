...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('payments', '0025_alter_paymentlog_reason_alter_reviewquestion_type_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='paymentlog',
            name='reason',
            field=models.CharField(blank=True, choices=[('MYSTERY SHOP', 'MYSTERY SHOP'), ('GREAT JOB - IN PERSON', 'GREAT JOB - IN PERSON'), ('OTHER', 'OTHER'), ('GREAT JOB - REMOTE', 'GREAT JOB - REMOTE')], max_length=255, null=True),
        ),
        migrations.AlterField(
